...
```
<br>Again, the graph and R squared value (0.0644) show that there basically doesn't exist a linear relationship between median household income and total crime in Wisconsin. This goes against the "common" knowledge that crime would increase the less wealthy the county is, but it looks like there is no relationship.
