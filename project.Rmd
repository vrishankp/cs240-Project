...
Finally, we wanted to conclusively answer our research question on the relationship between crime rate and poverty rate. Since the linear line is molded by:
...
The evidence is consistent(p = 0.148, two-sided t test) with $\beta_1$ equals to zero. Thus, there is no direct relationship between crime rate and poverty percentage in an area.
